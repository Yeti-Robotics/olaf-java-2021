 ...
 public class GalacticSearchCommandGroup extends SequentialCommandGroup {
   ...
   public GalacticSearchCommandGroup(IntakeSubsystem intakeSubsystem, DrivetrainSubsystem drivetrainSubsystem) {
     ...
     addCommands(
       new ToggleIntakePistonCommand(intakeSubsystem).withTimeout(1),
       new DetectGalacticSearchCommand(),
             new PlayGalacticSearchPathCommand(intakeSubsystem, drivetrainSubsystem)
     );
   }
 }

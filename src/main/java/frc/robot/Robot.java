...
//    camera.setResolution(640, 480);
  ...
  public void robotPeriodic() {
    ...
    System.out.println("Distance: " + Limelight.getHorDistance() + "; Angle: " + m_robotContainer.hoodSubsystem.hoodAngleFromEncoder(m_robotContainer.hoodSubsystem.getEncoder()) + "; goal: " + m_robotContainer.hoodSubsystem.calcHoodAngle(Limelight.getHorDistance()));
